...
class _RegistrationPageWidgetState extends State<RegistrationPageWidget> {
  ...
  void initState() {
    ...
    _model.passwordVerificationController ??= TextEditingController();
  }
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: InkWell(
                                      onTap: () => setState(
                                        () => _model
                                                .passwordVerificationVisibility =
                                            !_model
                                                .passwordVerificationVisibility,
                                      ),
                                      focusNode: FocusNode(skipTraversal: true),
                          ...
                          onPressed: () async {
                            ...
                            setState(() {
                              FFAppState().updateUserStruct(
                                (e) => e..isRegistration = true,
                              );
                            });
                            GoRouter.of(context).prepareAuthEvent();
                            if (_model.passwordController.text !=
                                _model.passwordVerificationController.text) {
