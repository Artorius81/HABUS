...
class UpdatePostWidget extends StatefulWidget {
  ...
  final UserPostsRow? currentPost;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'tqijosb2' /* Поделитесь с нами своими мысля... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'mnu3tpsv' /* Добавьте сюда фото записи или ... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                        ...
                                        child:
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final imageUserPostsRow =
                                                imageUserPostsRowList.isNotEmpty
                                                    ? imageUserPostsRowList
                                                        .first
                                                    : null;
                                            return InkWell(
